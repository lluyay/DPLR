...
#     snapshot_path = "../model/{}/{}".format(FLAGS.exp, FLAGS.model)
    snapshot_path = "/data/YayuanLu/BraTS19/model/3D_25suojin0/{}_{}_labeled/{}".format(
        FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
    num_classes = 2
#     test_save_path = "../model/{}/Prediction".format(FLAGS.exp)
    test_save_path = "/data/YayuanLu/BraTS19/model/3D_25suojin0/{}_{}_labeled/Prediction".format(
